...
3. 使用 `git clone https://github.com/SWRT-dev/86u-asuswrt` 命令下载好源代码
...
6. 然后 `cd ../86u-asuswrt/release/src-rt-5.02hnd` 进入目录

7. 输入 `make rt-ac86u` 即可开始编译你要的固件了。

8. 编译完成后输出固件路径：86u-asuswrt/release/src-rt-5.02hnd/image
