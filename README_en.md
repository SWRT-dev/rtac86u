...
3. Enter `git clone https://github.com/SWRT-dev/86u-asuswrt` to download source code 
...
6. Then enter `cd ../86u-asuswrt/release/src-rt-5.02hnd` to enter folder

7. Enter `make rt-ac86u` to start compiling the firmware

8. The firmware is in 86u-asuswrt/release/src-rt-5.02hnd/image
